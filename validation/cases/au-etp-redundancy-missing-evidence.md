---
id: au-etp-redundancy-missing-evidence
synthetic: true
target_skills:
  - au-etp-redundancy
---

# Termination payment and redundancy workpapers with missing evidence
...
Use `au-etp-redundancy` to prepare the supported work and an unresolved-items hand-off.
