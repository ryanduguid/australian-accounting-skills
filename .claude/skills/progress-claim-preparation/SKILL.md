...
12. **Diarise the respondent's clocks at service.** Payment schedule deadline (NSW s 14, Qld s 76), due date for payment (Qld default BIF s 73(1)(b), caps in QBCC Act ss 67U and 67W, pay-when-paid void under BIF s 74(1); NSW tiered principal-to-head-contractor and head-contractor-to-subcontractor), and the adjudication window. Keep each contractual deadline in its actual unit or fixed date, then compare it with the applicable statutory limit: NSW ss 11(1A)(b), 11(1B)(b), 11(1C)(a) and 14(4)(b)(i), and Qld ss 73(1)(a) and 76(1)(a). Do not convert calendar days to business days. Use business-day counting only where the governing provision or contract requires it, applying the relevant definition and holiday exclusions from the current Act and QBCC guidance. NSW requires a notice of intention to apply for adjudication where no payment schedule is given, and skipping it is fatal; Queensland has no equivalent step.
