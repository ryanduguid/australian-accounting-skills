...
8. Total fuel tax credit entitlement for the preceding and current 12-month periods as PCG 2021/2 and PCG 2016/2 measure them, to test the safe-harbour ceilings read from those guidelines
...
2. **Settle who acquired the fuel.** FTR 2009/1: a question of fact, not who burnt it. Wet hire, a flat inclusive fee, or free fuel points to the hire company retaining it; on-sale or mutuum points to the hirer. s 41-15 denies the credit to the second claimant unless the first has an increasing fuel tax adjustment for it, so name one claimant per litre in a hire chain.
...
10. **Attribute and label.** s 65-5 attributes the credit to the period the input tax credit for the fuel is or would be attributable to, so a cash-basis claimant claims the part of the credit that matches the consideration provided in each period, and a non-cash claimant in the earlier of the period any consideration is provided or the period an invoice is issued, provided the tax invoice is held when the BAS is lodged. The later-period election in s 65-5(4) to (6) is a separate choice, not an invoice-only rule. Credits go to 7D and over-claims to 7C; take the side each adjustment and error correction falls on from the ATO 'How to complete your activity statement labels' page (QC33684) rather than from memory, because the increasing and decreasing directions reverse easily. Enter zero where there is nothing to report. Hand the labels and supporting workpaper to the authorised BAS preparer for the rest of the statement.
