...
6. **Trust UPEs.** Identify unpaid present entitlements owed to corporate beneficiaries. The High Court held in *Bendel* [2026] HCA 18 that, on the facts before it, the UPE was not of itself a Div 7A loan. The ATO currently marks TD 2022/11 as under review following the decision, not withdrawn — check and cite the current ATO decision impact statement, ruling status and any legislative response at the time of the work, then flag the position to the reviewer rather than asserting it.
